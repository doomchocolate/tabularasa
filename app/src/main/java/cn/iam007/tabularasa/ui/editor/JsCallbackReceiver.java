...
import cn.iam007.tabularasa.utils.LogUtil;
...
public class JsCallbackReceiver {
    ...
    private final JsCallbackListener mListener;

    private Set<String> mPreviousStyleSet = new HashSet<>();

    public JsCallbackReceiver(JsCallbackListener listener) {
        mListener = listener;
    }

    @JavascriptInterface
    public void executeCallback(String callbackId, String params) {
        LogUtil.d(callbackId + ":" + params);
        switch (callbackId) {
            ...
            case CALLBACK_SELECTION_CHANGED:
                ...
                Set<String> selectionKeyValueSet =
                        Utils.splitDelimitedString(params, JS_CALLBACK_DELIMITER);
            ...
            case CALLBACK_INPUT:
                ...
                String fieldId = null;
                try {
                    fieldId = params.split("=")[1].split("~")[0];
                } catch (Exception e) {

                }
                mListener.onInput(fieldId);
                break;
...
//                mListener.onLinkTap(params);
            ...
            case CALLBACK_RESPONSE_STRING:
                ...
                Set<String> responseKeyValueSet =
                        Utils.splitDelimitedString(params, JS_CALLBACK_DELIMITER);
